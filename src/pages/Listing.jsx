  ...
  return (
    <main>
      ...
      <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg border-3 shadow-lg bg-white lg:space-x-5 z-10'>
         <div className='w-full h-[200px] lg-[400px]'>
              <p className='text-2xl font-bold mb-3 text-blue-900'>{listing.name} - $ {listing.offer ? listing.discountedPrice.toString()
                  ...
                  <div className='flex justify-start items-center space-x-4 w-[75%]'>
                            ...
                            <p className='w-full max-w-[200px] bg-green-800 rounded-md p-1 text-white text-center text-semibold shadow-md'>{listing.offer && (
         ...
         <div className='bg-blue-300 w-full h-[200px] lg-[400px] overflow-x-hiddin'></div>     
      </div>
    </main>
  );
}
