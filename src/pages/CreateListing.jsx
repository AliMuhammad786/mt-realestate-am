...
export default function CreateListing() {
  ...
  return (
    <main className="mx-w-md px-2 mt-auto">
      ...
      <form>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            The first image will be the cover (max images 6)
          </p>
          <input
            type="file"
            id="images"
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
        >
          Create Listing{" "}
        </button>
      </form>
